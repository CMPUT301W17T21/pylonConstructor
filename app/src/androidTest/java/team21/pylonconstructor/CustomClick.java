...
/**
 * Edited to remove a constraint which caused espresso to be unable to click invisible buttons.
 *
 * Original script from: https://android.googlesource.com/platform/frameworks/testing/+/
...
public final class CustomClick implements ViewAction {
    /**
     ...
     */
        ...
        public CustomClick(Tapper tapper, CoordinatesProvider coordinatesProvider,
        ...
        public Matcher<View> getConstraints() {
            ...
            //Getting rid of default check as our button is invisible
            Matcher<View> standardConstraint = isClickable(); //isDisplayingAtLeast(0);
